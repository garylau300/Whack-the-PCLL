...
window.COURSE_DETAILS = {
  PCLL8010: {
    ...
    materials: [
      ...
      'Hong Kong Civil Court Practice — Desk Edition ("Blue Book") (Lexis)',
      'Hong Kong Civil Procedure ("White Book") (Westlaw)',
    ],
    ...
    assessmentNotes: [
      ...
      'Re-examinations (if allowed) only require re-sitting the paper(s) where you scored below 50% of that paper’s marks; marks from papers you already passed carry over.',
