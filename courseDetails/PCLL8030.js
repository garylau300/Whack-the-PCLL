          ...
          },
          {
            ...
            answering: {
              flowchart: {
                ...
                steps: [
                  ...
                  {
                    label: 'State the purpose the duty serves — this is what De Monsa turns on',
                    detail: 'De Monsa separates two things that had been run together. Delivery of the originals deals with the right of property in those documents as chattels; giving good title is a different obligation, namely that the purchaser shall not be at risk of a successful assertion against him of any encumbrance. The duty to EXPLAIN a missing original serves the second purpose, not the first.',
                    why: 'Once the two purposes are pulled apart the result follows on its own. A chattel right can only reach what the vendor actually holds, so it cannot generate a duty about deeds he does not have; and an explanation is worth demanding only where the missing deed could genuinely put an encumbrance on the purchaser.',
                    exam: {
                      write: 'The purchaser\'s proprietary right to the title documents as chattels is a different matter from the obligation to give good title, which is an obligation that the purchaser shall not be at risk of a successful assertion against him of any encumbrance: De Monsa Investments Ltd v Whole Win Management Fund Ltd [2013] 5 HKC 350, CFA.',
                    ...
                    points: [
                      ...
                      'The obligation to give good title is the separate one: that the purchaser shall not be at risk of a successful assertion against him of any encumbrance.',
                      ...
                      'A purchaser who completes with actual knowledge of an unregistered memorandum of deposit and then registers his assignment still takes free of the equitable mortgage — which is why knowledge of the risk is not the same as exposure to it.',
                    ],
                  },
                  {
            ...
            skeleton: {
              bullets: [
                ...
                'State the purpose: property in the deeds as chattels, and keeping an encumbrance off the purchaser.',
