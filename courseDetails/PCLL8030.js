      ...
      examNotes: {
        ...
        issueTypes: [
          ...
          },
          {
            ...
            triggers: {
              bullets: [
                'The agreement is dated 3 March 2015 and the vendor can produce certified copies, but not the originals, of three assignments in the chain of title.',
                'The sale and purchase agreement was signed on 2 May 2008 and the vendor says s13A governs what he must hand over.',
                'The agreement provides that the vendor shall give title in accordance with the common law rather than s13A.',
                'The vendor\'s solicitor has sworn a statutory declaration saying that after extensive searches he cannot explain how the original deeds came to be missing.',
                'The purchaser objects that the missing originals may have been deposited to secure an equitable mortgage.',
                'Two sale and purchase agreements registered against the property were never completed, and both purchasers were finance companies.',
                'The flat is a Home Ownership Scheme flat subject to the alienation restrictions in s17B of the Housing Ordinance.',
                'Only the originals of documents more than 15 years old are missing, and the vendor says he need not account for them.',
                'The intermediate root refers to a deed of easement, and the purchaser demands delivery of the original of that deed as well.',
                'The vendor offers a certified copy taken from a photocopy, and the purchaser objects to it.',
              ],
              routes: [
                { when: 'The dispute is about what must be PRODUCED as proof of title rather than delivered', session: 'LG4', issue: 'statutory-period-s13', label: 'The statutory period for showing title' },
                { when: 'The dispute is whether a document counts as a document of title at all', session: 'LG3', issue: 'documents-of-title', label: 'Which documents are documents of title?' },
                { when: 'The originals and the certified copies are all missing', session: 'LG4', issue: 'missing-deeds-re-halifax', label: 'Missing title deeds and the rule in Re Halifax' },
              ],
            },
            answering: {
              flowchart: {
                ...
                steps: [
                  {
                    label: 'Separate showing title from giving title, and fix the s13 period',
                    detail: 'Showing title and giving title are two obligations over the same documents. Section 13(1) of the Conveyancing and Property Ordinance fixes the period over which title must be SHOWN, and that period is measured in 15 years; s13(2) lets a certified copy do that job. Giving title is the delivery of originals, and that is what this issue is about.',
                    why: 'Fix the 15 years first because it is not confined to showing title: s13A(1)(b) defines the delivery duty by reference to s13(1)(a) and (c), so the period settled here is the same period that decides how much has to be handed over later.',
                    exam: {
                      write: 'The vendor must SHOW title for the period fixed by s13(1)(a) of the Conveyancing and Property Ordinance — [the Government lease dating from [year], less than 15 years before the agreement dated [date], for the period since that grant / not less than 15 years before that agreement, commencing with the intermediate root, being the assignment dated [date]] — and must separately GIVE title by delivering originals.',
                      trap: 'Answering a delivery question with s13(2). A certified copy satisfies the duty to SHOW title; it can never discharge the duty to GIVE it.',
                    },
                    points: [
                      's13(1)(a)(i): where the grant of the Government lease was less than 15 years before the contract of sale, title is shown for the period since that grant.',
                      's13(1)(a)(ii): in any other case, not less than 15 years before the contract of sale, commencing with an assignment, a mortgage by assignment or a legal charge, each dealing with the whole estate and interest in the land — the intermediate root.',
                      's13(1)(b): any document referred to in that intermediate root which is not shown to have ceased or expired and subject to which any part of the land is disposed of.',
                      's13(1)(c): any power of attorney under which a produced document was executed, where that document was executed less than 15 years before the contract of sale.',
                      'The 15 years runs from the contract of sale, not from completion. The period used to be 60 years.',
                      's13(2): the original or a certified copy will do for showing title. Only an original will do for giving it.',
                    ],
                  },
                  {
                    label: 'Decide which giving-title regime applies',
                    detail: 'Handing over the original title deeds which relate exclusively to the property forms an important part of the vendor\'s duty to give good title. The statutory duty in s13A of the Conveyancing and Property Ordinance applies unless excluded or modified, so the common law duty applies in only two situations.',
                    why: 'The two regimes cut the duty down in different directions — De Monsa by purpose, s13A by period — so the same missing deed can be excusable under one and fatal under the other. Which one governs is therefore the first thing to settle.',
                    exam: {
                      write: 'The agreement being dated [date], [s13A of the Conveyancing and Property Ordinance governs the delivery of originals / the common law governs, the agreement pre-dating 11 July 2008 / the parties have expressly contracted for the common law duty, thereby excluding s13A].',
                      trap: 'Applying s13A to an old agreement. It has no retrospective effect and applies only to agreements signed after 11 July 2008: Donpower Trading Ltd v Apexcom [2010] 1 HKLRD 915, CA.',
                    },
                    points: [
                      'The common law applies where the sale and purchase agreement pre-dated 11 July 2008.',
                      'It also applies where the vendor agrees, by an agreement dated after 11 July 2008, to give title in accordance with the common law, thereby excluding the statutory provision.',
                      'Otherwise s13A governs. Condition 9 of Part A of the Second Schedule to the Conveyancing and Property Ordinance is commonly used to impose it in terms.',
                      'Where the agreement is silent as to title there is an implied term that the vendor must give good title: Timmins v Moreland Street Property Co Ltd [1958] 1 Ch 110; De Monsa Investments Ltd v Whole Win Management Fund Ltd (2013) 16 HKCFAR 419.',
                    ],
                  },
                  {
                    label: 'State the purpose the duty serves — this is what the De Monsa test rests on',
                    detail: 'The delivery duty and the good-title duty answer to different things. The vendor must hand over the originals because the purchaser has a proprietary right to them; but whether he has GIVEN good title turns on something else, namely whether the purchaser is exposed to a real risk that an encumbrance has been created which could be asserted against him after completion. The duty to EXPLAIN a missing original belongs to the second, not the first.',
                    why: 'The purposive test follows from this and cannot be stated without it. A proprietary right reaches only what the vendor actually holds, so it cannot generate a duty about deeds he does not have; and an explanation is worth demanding only where the missing deed could genuinely expose the purchaser to an encumbrance.',
                    exam: {
                      write: 'The vendor\'s inability to produce the original [document] puts him in breach of his duty to give good title only if it exposes the purchaser to a real risk that some encumbrance has been created to which he would be subject — here, an equitable mortgage by deposit of the missing deeds.',
                      trap: 'Using the proprietary right as the reason for demanding an explanation. The proprietary right explains what the vendor must hand over; the encumbrance risk explains what he must account for.',
                    },
                    points: [
                      'A purchaser has a proprietary right to the original documents relating exclusively to the property: Re Williams and Newcastle\'s Contract [1897] 2 Ch 144.',
                      'That right is an incident of the ownership of the land itself: Re Duthy and Jesson\'s Contract [1898] 1 Ch 419.',
                      'It is a right to the documents themselves — the lecture puts it as a right of property in them as chattels, a different matter from the obligation to give good title.',
                      'Giving good title is the obligation that the purchaser shall not be at risk of a successful assertion against him of any encumbrance.',
                      'The Court of Appeal in Zhang put the enquiry as whether there is a real risk of an encumbrance in the form of an equitable mortgage which may be successfully asserted against the purchaser after completion: [2015] 2 HKLRD 246 at [40].',
                      'A purchaser who completes with actual knowledge of an unregistered memorandum of deposit and then registers his assignment still takes free of the equitable mortgage — which is why knowledge of a risk is not the same as exposure to it.',
                    ],
                  },
                  {
                    label: 'Apply the common law duty as restated in De Monsa',
                    detail: 'The vendor must deliver at completion the originals of the title deeds relating exclusively to the property that are actually in his possession or power. For those that are not, he must explain their absence only where that absence would indicate the realistic possibility of some transaction affecting the land which could affect the purchaser if he took title.',
                    why: 'This is the purposive restriction in operation. The test is not how old the document is but whether its absence threatens the purchaser\'s title — which is why the duty reaches pre-root documents but excuses most of them.',
                    exam: {
                      write: 'At common law the vendor must hand over at completion the originals in his possession or power; as to the remainder, his inability to account for them to the standard required for secondary evidence would justify refusal to complete only where their absence indicates the realistic possibility of some transaction affecting the land which could affect the purchaser if he took title.',
                      trap: 'Requiring a Re Halifax statutory declaration for every missing original. On De Monsa, resort to Re Halifax will at best be rare and may never be necessary.',
                    },
                    points: [
                      'A purchaser is entitled to receive at completion the originals of title documents relating exclusively to the property, by virtue of his proprietary right to them.',
                      {
                        text: 'Only documents relating EXCLUSIVELY to the property qualify, and that filter is the common law\'s own — it pre-dates s13A by two years: Goldmex Ltd v Edward Wong Finance Co Ltd [2006] 2 HKLRD 795 (no duty to provide originals of title deeds which did not relate exclusively to the property sold).',
                        points: [
                          'Normally NOT exclusive, so no original need be delivered: the Government lease and Conditions of Grant, the deed of mutual covenant, the occupation permit and the certificate of compliance.',
                          'Normally exclusive, so the original must be delivered: assignments, mortgages and discharges.',
                      ...
                      'The duty to explain runs to missing originals in BOTH the pre- and post-intermediate root period: the common law draws no line at the root.',
                      'It is triggered only by the realistic possibility of some transaction affecting the land which could affect the purchaser if he took title.',
                      'It follows that resort to the rule in Re Halifax Commercial Banking Co Ltd and Wood (1898) 79 LT 536, CA will at best be rare and may never be necessary.',
                      'De Monsa did not truly overrule Yiu Ping Fong v Lam Lai Hing Lana [1998] 4 HKC 476: Yuen J was not concerned with pre-intermediate root documents, and later first instance decisions took her judgment out of context.',
                    ],
                  },
                  {
                    label: 'Work the equitable mortgage risk, which is the transaction actually feared',
                    detail: 'The transaction the rule is about is an equitable mortgage created by deposit of the original deeds. Litton NPJ in De Monsa divided it in two: a deposit accompanied by a memorandum of deposit, and a deposit unaccompanied by one.',
                    why: 'This is where the marks are. The risk is a lender emerging from the dark with an original title deed in his hands and registering a memorandum of deposit ahead of the purchaser, and whether that is fanciful is a question of degree on the facts rather than a proposition of law.',
                    exam: {
                      write: 'Any memorandum of deposit would be a registrable instrument which, unregistered, is null and void against a subsequent bona fide purchaser for valuable consideration under s3(2) of the Land Registration Ordinance, so once the assignment is registered the purchaser takes priority over the chargee and the risk is fanciful.',
                      trap: 'Stopping at the registration answer. Cheung CJHC in Zhang queried whether it holds where the memorandum only EVIDENCED the equitable mortgage rather than creating it, since s3(2) avoids the instrument and not the underlying transaction insofar as that can survive without it.',
                    },
                    points: [
                      'With a memorandum: registrable, and if unregistered void against a subsequent bona fide purchaser for valuable consideration under s3(2) of the Land Registration Ordinance, so there is no realistic risk to the purchaser\'s title.',
                      'Without a memorandum: nothing can be registered, but there is no instance in the law reports of an equitable mortgagee by deposit defeating the title of a purchaser.',
                      'It is difficult to imagine a lender advancing a substantial sum on nothing more than an oral commitment and a deposit of deeds when he could have taken a memorandum and registered it.',
                      'The obligation to explain springs from the circumstances of the particular case and is a matter of degree; it can be formulated on the officious bystander test, the matter being within the vendor\'s personal knowledge.',
                      'Facts known to the vendor to be material to the requisition must be disclosed.',
                    ],
                  },
                  {
                    label: 'Apply s13A where it governs: the temporal cut, made through s13',
                    detail: 'Under s13A(1), unless a contrary intention is expressed, the purchaser may require delivery of the original of two things only: the Government lease if it relates exclusively to the land, and any document that relates exclusively to the land and is required to be produced as proof of title under s13(1)(a) and (c). That cross-reference is what imports the 15-year period.',
                    why: 'This is the temporal restriction, and the statute names no period of its own — it borrows s13\'s. So the delivery duty stops exactly where the chain of title stops, which is usually little more than 15 years back.',
                    exam: {
                      write: 'Under s13A(1) of the Conveyancing and Property Ordinance the vendor need deliver only the Government lease, if it relates exclusively to the land, and those documents relating exclusively to the land required to be produced under s13(1)(a) and (c) — that is, the chain of title from the intermediate root, a period usually little more than 15 years.',
                      trap: 'Reading s13(1)(b) into s13A. Section 13A(1)(b) picks up s13(1)(a) and (c) only, so a document merely REFERRED TO in the intermediate root must be produced for showing title but need not be delivered in original.',
                    },
                    points: [
                      'Originals of title deeds falling within the pre-intermediate root period need not be supplied to the purchaser at all.',
                      'Section 13A(1)(a) has to name the Government lease separately for a drafting reason, not a substantive one: in s13(1) the Government lease sits in the opening words — "only production of the Government lease relating to the land sold and: (a) ... (c)" — outside paragraphs (a) to (c), so the cross-reference in s13A(1)(b) would not otherwise catch it.',
                      'It is then filtered by the same exclusivity test the common law applies, and the Government lease or Conditions of Grant will not usually relate exclusively to the property being sold — so in practice what remains is the chain-of-title documents.',
                      's13A(2): subsection (1) does not affect any rule of common law under which the vendor may discharge his obligation to give title otherwise than by delivering the Government lease or document.',
                      's13A(3): where the vendor is not required to deliver a document, the purchaser has no proprietary right or ownership in it — removing, to that extent, the right recognised in Re Duthy and Jesson\'s Contract [1898] 1 Ch 419.',
                      's13A(4): that the vendor need not deliver, and that the purchaser has no proprietary right, does not affect the right or interest of any other person in the land — so an equitable mortgagee holding the originals keeps his interest.',
                      'Failure to provide the originals in compliance with s13A is a repudiatory breach of the agreement: Big Most Ltd v Chau Wa Hung [2012] 4 HKLRD 599.',
                    ],
                  },
                  {
                    label: 'Address the open question: does De Monsa reach a s13A duty?',
                    detail: 'Section 13A(2) preserves the rules of common law by which a vendor may discharge his obligation to give title. Whether that lets the De Monsa purposive restriction into a case where the parties have contracted for title under s13A is unsettled.',
                    why: 'It matters because the two restrictions do not overlap. A deed can sit outside the 15-year chain and still carry a real encumbrance risk, or sit inside it and carry none — so which restriction applies can decide the case.',
                    exam: {
                      write: 'Section 13A(2) preserving the common law, it is arguable that the De Monsa restriction applies even where the parties have contracted to give title under s13A; Chu Yin Fan v Inter Rivers Ltd so held, though the contrary view is that the purposive restriction has no place in a statutory duty which carries a temporal restriction of its own.',
                      trap: 'Presenting the back door as settled law. It rests on a District Court decision and on a remark in De Monsa which the lecture itself calls mysterious.',
                    },
                    points: [
                      ...
                      'Chu Yin Fan v Inter Rivers Ltd DCCJ 4314/2012, 19/8/2016, [2017] HKEC 789: s13A(2) preserved the common law rule as enunciated in De Monsa, which should be applied where the parties had agreed to give title in accordance with s13A.',
                      'That conclusion admits the easier common law rule through the back door.',
                      'The alternative view is that De Monsa\'s purposive restriction does not apply to the statutory duty, the temporal restriction in s13A having merits of its own.',
                      'On that view the common law duty may now be LESS onerous than the statutory one, so solicitors may be well advised to contract for the common law duty instead — provided that does not contradict the preliminary agreement, or the purchaser agrees.',
                    ],
                  },
                  {
                    label: 'Test the conclusion against Zhang, where the vendor lost',
                    detail: 'In Zhang Xueshuai v Lai Chan Wing [2015] 2 HKC 125, [2015] 2 HKLRD 246, CA the vendor had contracted to give title under s13A but could supply only certified copies, with a statutory declaration by his solicitor that after extensive searches he could not explain how the originals came to be missing.',
                    why: 'Zhang is the control on a De Monsa answer. Where every original is gone and the property carries alienation restrictions, the encumbrance risk stops being fanciful and becomes real.',
                    exam: {
                      write: 'The statutory declaration speaks only to the period after the declarant took over and cannot properly explain the loss of the originals; almost all the title deeds being missing, the risk of an equitable mortgage is real, so the requisition was properly raised but has not been satisfactorily answered.',
                      trap: 'Missing why the alienation restrictions mattered. The flat was a Home Ownership Scheme flat under s17B of the Housing Ordinance, so the resulting equitable mortgage would be void either way unless the Director of Housing had approved.',
                    },
                    points: [
                      'Two sale and purchase agreements registered against the property had not been completed and both purchasers were financial lending institutions, raising a suspicion that they were disguised lending transactions.',
                      'The possibility that the then owner had used the original title documents for borrowing could not be excluded.',
                      'The statutory declaration covered only the period after the declarant took over and could not properly speak to the reason for the loss.',
                      'Almost all of the title deeds were missing, so the risk of an equitable mortgage was real rather than fanciful.',
                      'Held: the requisition had been properly raised but not satisfactorily answered, so good title was not shown.',
                    ],
                  },
                ],
              },
            ...
            lookOut: {
              bullets: [
                'Delivery of originals is part of GIVING title; production of an original or a certified copy is part of SHOWING it. The same documents, two duties — and s13(2) answers only the second.',
                'The 15 years is not confined to showing title. Section 13A(1)(b) defines the delivery duty by reference to s13(1)(a) and (c), so the statutory delivery duty is bounded by the same period.',
                'Section 13A(1)(b) picks up s13(1)(a) and (c) but NOT (b), so a document referred to in the intermediate root must be produced but need not be delivered in original.',
                'The "relates exclusively to the property" filter is NOT a s13A invention. It is the common law\'s own test, applied in Goldmex two years before s13A was enacted, so the Government lease is normally outside the delivery duty under EITHER regime — s13A(1)(a) names it only because s13(1) puts it in the chapeau, beyond the reach of the (a) and (c) cross-reference.',
                'Mind the wording gap: s13(1) requires production of the Government lease "relating to the land sold", with no exclusivity filter at all, so it must be SHOWN. Delivery, under s13A(1)(a) and at common law alike, is filtered by "relates exclusively", which the Government lease normally fails. Produced, but not handed over.',
                'The two restrictions are different cuts: De Monsa is purposive (does the absence indicate a realistic possibility of a transaction affecting the land?), s13A is temporal (does the document fall within the chain of title period?).',
            ...
            skills: {
              bullets: [
                'Date the agreement in the first line. It picks the regime, and the regime decides everything after it.',
                'Fix the s13(1)(a) period before arguing about any particular deed — under s13A the period is the answer.',
                'State the purpose before applying the De Monsa test. An answer that says what the duty is for can then explain why a given absence does or does not matter, instead of asserting it.',
                'Answering a requisition, name the specific transaction feared and say why it is fanciful on these facts. A bare statutory declaration did not save the vendor in Zhang.',
                'Advising a vendor with missing originals, consider contracting for the common law duty instead, and check that the preliminary agreement permits it.',
              ],
            },
            skeleton: {
              bullets: [
                'Separate showing title from giving title, and fix the s13(1)(a) period.',
                'Date the agreement and identify the governing regime: common law or s13A.',
                'Identify which documents relate exclusively to the property.',
                'State the purpose: the purchaser\'s proprietary right to the deeds, and keeping an encumbrance off his title.',
                'Common law: which originals are in the vendor\'s possession or power?',
                'For the rest, is there a realistic possibility of a transaction affecting the land?',
                'Section 13A: does the document fall within the s13(1)(a) and (c) chain of title period?',
                'Work the equitable mortgage risk through s3(2) of the Land Registration Ordinance and say whether it is fanciful or real.',
                'Conclude on whether good title has been given, and state the remedy.',
              ],
            },
            mistakes: {
              bullets: [
                'Applying s13A to a pre-11 July 2008 agreement.',
                'Using s13(2) to answer a question about what must be DELIVERED.',
                'Never stating the 15-year period, and so never explaining where the s13A cut-off comes from.',
                'Measuring the 15 years from completion rather than from the contract of sale.',
                'Reading s13(1)(b) into s13A(1)(b), which picks up (a) and (c) only.',
                'Treating the exclusivity filter as something s13A introduced, when Goldmex applied it at common law in 2006.',
                'Demanding the original Government lease on a flat. It is produced for showing title, but rarely relates exclusively to the flat, so it is not delivered under either regime.',
            ...
            authorities: {
              statutes: [
                ...
                { text: 'It is true that the focus in the present context is whether there is a real risk of an encumbrance in the form of an equitable mortgage which may be successfully asserted against the purchaser after completion.', cite: 'Zhang Xueshuai v Lai Chan Wing [2015] 2 HKLRD 246, CA at [40], as reproduced in the LG3 slides' },
              ],
              table: {
                headers: ['Point', 'Authority', 'What it establishes'],
                rows: [
                  ['The period', 's13(1)(a), Conveyancing and Property Ordinance (Cap. 219)', 'Since the grant where the Government lease is less than 15 years old at the contract of sale; otherwise not less than 15 years, from a qualifying intermediate root'],
                  ['Why the period exists', 'Wu Wing Kuen v Leung Kwai Lin Cindy [2001] 1 HKLRD 212', 'Section 13(1) was enacted to facilitate conveyancing by reducing the time for which the vendor must prove title; an enabling provision, not a bar on secondary evidence'],
                  ['Form of production', 's13(2); De Monsa Investments Ltd v Whole Win Management Fund Ltd [2013] 5 HKC 350, CFA', 'Original or certified copy for SHOWING title; a certified copy of a certified copy is acceptable, of a plain copy is not'],
                  ['Proprietary right', 'Re Williams and Newcastle\'s Contract [1897] 2 Ch 144; Re Duthy and Jesson\'s Contract [1898] 1 Ch 419', 'The purchaser has a proprietary right to the documents relating exclusively to the property, as an incident of ownership of the land'],
                  ['The protective purpose', 'De Monsa Investments Ltd v Whole Win Management Fund Ltd [2013] 5 HKC 350, CFA', 'Giving good title is the distinct obligation that the purchaser shall not be at risk of a successful assertion against him of any encumbrance'],
                  ['Exclusivity filter', 'Goldmex Ltd v Edward Wong Finance Co Ltd [2006] 2 HKLRD 795', 'No duty to provide originals of title deeds which do not relate exclusively to the property sold — a common law rule, pre-dating s13A'],
                  ...
                  ['Restated', 'De Monsa Investments Ltd v Whole Win Management Fund Ltd [2013] 5 HKC 350, CFA', 'Originals in possession or power; an explanation only where the absence indicates a realistic possibility of a transaction affecting the land'],
                  ['Equitable mortgage risk', 's3(2), Land Registration Ordinance (Cap. 128)', 'An unregistered but registrable memorandum of deposit is void against a subsequent bona fide purchaser for valuable consideration'],
                  ['The statutory duty', 's13A(1), Conveyancing and Property Ordinance (Cap. 219)', 'Government lease relating exclusively to the land, plus documents required under s13(1)(a) and (c) — not (b)'],
                  ...
                  ['Ownership of deeds removed', 's13A(3)', 'No proprietary right or ownership in a document the vendor need not deliver'],
                  ['Third parties preserved', 's13A(4)', 'Rights of other persons in the land are unaffected, such as an equitable mortgagee holding the originals'],
                  ...
                  ['Where it failed', 'Zhang Xueshuai v Lai Chan Wing [2015] 2 HKC 125, [2015] 2 HKLRD 246, CA', 'Almost all originals missing; HOS flat under s17B Housing Ordinance; equitable mortgage risk real; requisition not satisfactorily answered'],
                ],
              },
            },
            notes: [
              {
                heading: 'Untangling the three duties: s13, s13A and the common law',
                bullets: [
                  ...
                  's13A and the common law both govern GIVING title: a physical, delivery duty. The vendor must actually hand over documents at completion, and only the original will do — a certified copy cannot discharge either duty, however well it serves the duty to show title.',
                  's13A and the common law are ALTERNATIVES, not two layers of the same duty. Which one applies turns on the date of the agreement, or on an express choice — never both at once on the same document.',
                  'The link people miss is that s13A is not independent of s13: s13A(1)(b) defines what must be delivered by reference to what s13(1)(a) and (c) require to be produced. So the 15-year period set by s13 for showing title is also what bounds the statutory duty to deliver.',
                ],
                table: {
                  headers: ['', 's13 — showing title', 's13A — giving title', 'Common law — giving title'],
                  rows: [
                    ['The question it answers', 'May the purchaser SEE the paper trail?', 'Which originals must be HANDED OVER?', 'Which originals must be HANDED OVER?'],
                    ['What the duty is for', 'Facilitating conveyancing by reducing the length of time for which the vendor must prove title: Wu Wing Kuen v Leung Kwai Lin Cindy [2001] 1 HKLRD 212', 'Alleviating a common law duty the legislature found unworkable where originals had been lost or destroyed', 'Two things: the purchaser\'s proprietary right to the deeds, and — the one that decides good title — keeping him clear of an encumbrance: De Monsa'],
                    ['How far back it reaches', 'Since the grant where the Government lease is less than 15 years old at the contract of sale; otherwise not less than 15 years, from the intermediate root: s13(1)(a)', 'Exactly as far as s13(1)(a) and (c) reach, because s13A(1)(b) borrows them — the chain of title, usually little more than 15 years', 'Everything relating exclusively to the property, with no period limit — but only what is in the vendor\'s possession or power'],
                    ['Which documents qualify', 'The Government lease "relating to the land sold" plus the chain — no exclusivity filter at all: s13(1)', 'Only what relates EXCLUSIVELY to the land: s13A(1)', 'Only what relates EXCLUSIVELY to the property: Goldmex Ltd v Edward Wong Finance Co Ltd [2006] 2 HKLRD 795'],
                    ['Form that satisfies it', 'The original or a certified copy: s13(2)', 'Only the original', 'Only the original'],
                    ['When it applies', 'Always, subject to the agreement', 'Agreements made on or after 11 July 2008, unless the parties contract for the common law instead', 'Agreements made before 11 July 2008, or where the parties expressly contract for it'],
                    ['A missing original', 'Not in issue — a certified copy is all s13 ever asked for', 'Outside those two categories there is no duty to deliver, so there is nothing to explain', 'Explain only where the absence indicates a realistic possibility of a transaction affecting the land: De Monsa'],
                  ],
                },
              },
              {
                heading: 'Purposive or temporal: why the two restrictions do not line up',
                bullets: [
                  'De Monsa restricts the common law duty by PURPOSE. A missing original matters only if its absence indicates the realistic possibility of some transaction affecting the land which could affect the purchaser if he took title — because the obligation being protected is that the purchaser shall not face a successful assertion of an encumbrance.',
                  'Section 13A restricts the statutory duty by PERIOD. It requires delivery only of what s13(1)(a) and (c) require to be produced, so the duty stops where the chain of title stops, and asks no question about risk at all.',
                  'The lecture labels them in exactly those terms: De Monsa a purposive restriction, s13A a temporal one.',
                  'Because the cuts are different they do not line up. A deed from 1962, far outside the chain of title, falls outside the s13A duty altogether; but at common law its absence must still be explained if it suggests an equitable mortgage by deposit.',
                  'Conversely a deed from well inside the 15-year chain must be delivered in original under s13A whether or not anybody suspects an encumbrance — subject only to the unresolved s13A(2) question.',
                  'That asymmetry produces the irony the lecture draws out: after De Monsa the common law duty may be LESS onerous than the statutory one, which is why a vendor with missing originals may prefer to contract for the common law duty instead.',
                ],
              },
            ],
            crossRefs: [
